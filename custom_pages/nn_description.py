...
with st.expander("ข้อมูลเพิ่มเติมเกี่ยวกับชุดข้อมูล"):
    ...
    st.write("""
    ข้อมูลชุดนี้มาจาก **TensorFlow Datasets** ซึ่งรวมถึงชุดข้อมูลที่ได้รับความนิยมในการ train โมเดล เช่น **MNIST**, **Fashion MNIST**, และ **CIFAR-10** โดยในโมเดลนี้จะเป็นการใช้งาน Model Architecture แบบเดียวเพื่อเป็นการแสดงให้เห็นว่าแต่ละข้อมูลนั้นจะมีความเหมาะสมกับ Model Architecture ที่ต่างกันไป [ลิ้งค์นี้](https://www.tensorflow.org/datasets/catalog/overview?hl=th)
    """)
    ...
    - **Train Data**: รูปภาพและ label ของข้อมูล train
    - **Test Data**: รูปภาพและ label ของข้อมูล test
